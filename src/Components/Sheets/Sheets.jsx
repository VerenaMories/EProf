    ...
    <>
      <section class="pager-section">
        <div class="container">
          ...
          <Fade top duration={1000} delay={500}><h2>Sheets</h2></Fade>  
            <ul>
              <li>
...
>
  {AllFilter.map((item) => (
    <div className="classes-col" style={{paddingRight:'3%'}} key={item._id}>
    <div
    ...
    >
      ...
      <div className=" d-flex flex-wrap align-items-center" style={{justifyContent:'space-between'}}>
        <div className="posted-by "> 
          <img src= {item.instructor.img ? item.instructor.img : verena} alt=""  style={{ width: "45px",height:'45px',borderRadius:'50%' }}/>
          <a
        ...
        <strong className="price" style={{color:'#3c719a'}}>{item.price} EGP </strong>
      </div>
    </div>
  </div>
  ))}
