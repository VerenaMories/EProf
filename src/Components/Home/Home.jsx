...
export default function Home() {
	...
	useEffect(() => {
		axios.get('https://eprof-zu1o.onrender.com/admin/allImgs')
		  .then(response => {
...
useEffect(() => {
  ...
  <input type="text" name="search" placeholder="Search" onKeyDown={handleKeyDown} />
  <button type="submit" onClick={handleSearchClick}><i class="fa fa-search"></i></button>
</form>
										{/* {allData.map(item => (
				...
				<section class="about-us-section">
					<div class="container">
						<div class="section-title text-center">
							...
							{/* <h2></h2> */}
							<Fade bottom duration={1000} delay={500}>	<p>It is an e-learning platform that strives to assist students have a smart and intelligent future.</p></Fade>
						</div>
						<div class="about-sec">
							<div class="container">
								<div class="row">
    ...
    //   showDots={true}
      ...
      itemClass="carousel-item-padding-40-px"
								 >
        {imgs.map(img => (
          <img src={img.img} alt="carousel-img" key={img._id} style={{width:'100%', height:'30vh'}}/>
        ))}
      </Carousel>
					</Fade>			
				...
				<section class="classes-section">
					<div class="container">
						<div class="sec-title">
						<Fade left duration={1000} delay={500}>	<h2>Our Classes</h2></Fade>
						<Fade left duration={1000} delay={500}><p>We provide diploma lessons of all types to ensure that each student finds the ideal solution for their future.</p></Fade>
						</div>
						...
						<div class="classes-sec">
							...
							<div class="lnk-dv text-center" >
								<Link to='/classes' style={{ textDecoration: 'none',padding:'0 60px' }} title="" class="btn-default">
								<Fade bottom duration={1000} delay={500}>	
									Classes </Fade><i class="fa fa-long-arrow-alt-right"></i></Link>
							</div>
						</div>
					</div>
				</section>
				...
				<section class="teachers-section">
					<div class="container">
						<div class="section-title text-center">
						<Fade bottom duration={1000} delay={500}>	<h2>Our Awesome <br /> Instructors</h2></Fade>
						<Fade bottom duration={1000} delay={500}>	<p>We guarantee that we have the best, most knowledgeable instructors to provide you with the best educational service possible.</p></Fade>
						</div>
						<div class="teachers">
							{/* <TeacherCarousel/> */}
							<div class="row">
...
>
  {teacherData.filter(item => !item.block).map(item => (
    <div class="col col-sm-12 full-wdth" key={item._id}  style={{display:'flex',justifyContent:'center'}}>
      <div class="teacher">
        <div class="teacher-img">
          <img src={item.img ? item.img : verena} alt=""   onClick={() => NavTeacher(item._id)} style={{ width: '376px', height: '624px', cursor:'pointer' }} />
          <div class="sc-div">
        ...
        <div class="teacher-info">
          ...
          {/* {console.log(item.subjectId?.name)} */}
								...
								<div class="lnk-dv text-center" style={{marginBottom:'3%',paddingTop:'3%'}}>
								<Link to='/teachers' style={{ textDecoration: 'none' ,padding:'0 60px'}} title="" class="btn-default">
								<Fade bottom duration={1000} delay={500}>
									Instructors 
									</Fade>
									<i class="fa fa-long-arrow-alt-right"></i></Link>
							</div>
  ...
  <ResponsiveContainer
    ...
    render={(width, carouselRef) => {
      ...
      const responsiveSlideWidth = Math.floor(width / currentVisibleSlide);
	  const customScales = Array.from({ length: (currentVisibleSlide + 3) / 2 }, (_, i) => {
