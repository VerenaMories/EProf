							...
							<div class="sidebar class-sidebar">
								<div class="widget widget-information">
									...
									<div class="tech-info">
										...
										<Link to='/contact' style={{ textDecoration: 'none', marginBottom: "2%" }} title="" class="btn-default">Enroll Now <i class="fa fa-long-arrow-alt-right"></i></Link>
										<Link to='/contact' style={{ textDecoration: 'none' }} title="" class="btn-default">Buy Lecture <i class="fa fa-long-arrow-alt-right"></i></Link>
